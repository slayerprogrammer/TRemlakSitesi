...
{
    public class ProjeEmlakKonutMap : EntityTypeConfiguration<ProjeEmlakKonut>
    {
        public ProjeEmlakKonutMap()
        {
            ToTable(@"ProjelerEmlakKonut", @"dbo");
            HasKey(x => x.projeleremlakkonut_ID);
