...
{
    public class GunlukKiralikDaireMap : EntityTypeConfiguration<GunlukKiralikDaire>
    {
        public GunlukKiralikDaireMap()
        {
            ToTable(@"GunlukKiralikDaireler", @"dbo");
            HasKey(x => x.gunlukkiralikdaireler_ID);
